                     ...
                     <div class="card-body product-form">
                        ...
                        <form method="POST" enctype="multipart/form-data">
                           ...
                           <div class="form-group w-50">
                              ...
                              <textarea type="text" name="meta_title" class="form-control"  placeholder="Enter Category" required value="<?php echo $short_desc;?>"></textarea>
                           </div>

                           <div class="form-group w-50">
                              <label for="exampleInputEmail1">Meta Description</label>
                              <textarea type="text" name="meta_desc" class="form-control"  placeholder="Enter Category" required value="<?php echo $short_desc;?>"></textarea>
                           </div>
